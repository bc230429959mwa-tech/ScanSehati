...
function AuthGuard({ children }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AuthGuard.useEffect": ()=>{
            // Since localStorage is not available on the server, we need to check it on the client.
...
_s(AuthGuard, "GUgOdXof8eGsUMGUUz3DvIoLNGM=", false, function() {
    return [
...
function PatientDashboard() {
    ...
    const removeDrug = (id)=>{
        ...
        setMedications(updatedMeds);
        runInteractionCheck(updatedMds.map((m)=>m.name));
    };
...
_s(PatientDashboard, "35tmZeMGmcdUtglda5D+6mFodGA=", false, function() {
    return [
...
//# sourceMappingURL=_7abbb7cb._.js.map